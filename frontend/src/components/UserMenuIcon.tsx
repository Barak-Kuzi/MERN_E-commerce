                        ...
                        <nav>
                            <ul className={styles.navigation_list}>
                                <li>
                                    ...
                                    <Link to={"/user-panel/user-profile"} onClick={handleMenuDisplay}>
                                        My Profile
                                    </Link>
                                </li>
                                <li>
                                    ...
                                    <Link to={"/user-panel/user-wishlist"} onClick={handleMenuDisplay}>
                                        My Wishlist
                                    </Link>
                                </li>
                                <li>
                                    ...
                                    <Link to={"/user-panel/user-orders"} onClick={handleMenuDisplay}>
                                        My Orders
                                    </Link>
                                </li>
                                <li>
                                    ...
                                    <Link to={"/user-panel/user-settings"} onClick={handleMenuDisplay}>
                                        Account Settings
                                    </Link>
                                </li>
                                {
