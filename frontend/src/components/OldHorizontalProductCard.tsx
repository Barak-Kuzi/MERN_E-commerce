...
export default function OldHorizontalProductCard({title, category}: HorizontalProductCardProps): React.JSX.Element {
    const {products, isLoading, error} = useFetchProductsByCategory({category: category || ''});
